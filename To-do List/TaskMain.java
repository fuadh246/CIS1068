...
public class TaskMain {
        public static void main(String[] args) {
                ...
                System.out.println();
                Task postHW2 = new Task("post 1068 homework", 1, LocalDateTime.of(2022, 12, 23, 13, 0), 180);
                System.out.println(postHW.getName() + " assignment");
                System.out.println("This has priority " + postHW.getPriority() + ", should take me "
                                + postHW.getEstMinsToComplete() + " minutes");
                System.out.println("and it's due on " + postHW.getWhenDue());
                ...
                honeydo.addTask(new Task("post 1068 homework", 1, LocalDateTime.of(2022, 3, 23, 13, 0), 160));
                honeydo.addTask(new Task("Make Sandwiches", 2, LocalDateTime.of(2022, 12, 23, 13, 0), 20));
                honeydo.addTask(new Task("Water Plant", 1, LocalDateTime.of(2023, 1, 23, 13, 0), 8));
                System.out.println(honeydo);
